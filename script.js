...
// ==================== Shijiazhuang Popup Modal (网页内弹窗) ====================
// 等待 DOM 加载完成后显示弹窗
document.addEventListener('DOMContentLoaded', function() {
  const modal = document.getElementById('ShijiazhuangModal');
  const closeSpan = document.querySelector('.Shijiazhuang-close');
  const closeBtn = document.getElementById('ShijiazhuangModalCloseBtn');
